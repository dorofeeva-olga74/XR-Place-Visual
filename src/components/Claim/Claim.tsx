    ...
    <div className={styles.claim__container}>
      <form>
        ...
        <small className={styles.claim__annotation}>
          Нажимая на кнопку, вы принимаете <span className={styles.claim__annotation}>условия использования</span> и <span className={styles.claim__annotation}>политику конфиденциальности</span>
        </small>
      </form>
    </div>
  );
